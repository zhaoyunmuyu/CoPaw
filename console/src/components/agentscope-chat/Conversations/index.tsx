...
const Conversations: React.FC<
  ConversationsProps & { groupable?: boolean | Groupable }
> = (props) => {
  const {
  ...
  const onConversationItemClick: ConversationsItemProps["onClick"] =
    React.useCallback(
      (info) => {
