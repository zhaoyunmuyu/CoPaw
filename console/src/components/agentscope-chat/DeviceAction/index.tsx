    ...
    <div>
      ...
      <OperateCard
        header={{
          ...
          icon: (
            <div className={`${prefixCls}-device-action-icon`}>
              {actionMap[props.action]?.icon}
            </div>
          ),
          title: (
            <div className={`${prefixCls}-device-action-content`}>
              <div className={`${prefixCls}-device-action-description`}>
                <span>{props.actionName || actionMap[props.action]?.name}</span>
