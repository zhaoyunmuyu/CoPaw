...
export interface StickToBottomOptions extends SpringAnimation {
  /**
   * Whether the stick-to-bottom behavior is enabled.
   * When set to `false`, auto-scrolling to bottom on content resize is disabled.
   *
   * @default true
   */
  enabled?: boolean;
...
export const useStickToBottom = (
  ...
  const [isAtBottom, updateIsAtBottom] = useState(
    options.enabled !== false && options.initial !== false,
  );
